...
Datos sobre nombres de guaguas (bebés) registrados en Chile entre 1920 y 2020, según el Servicio de Registro Civil e Identificación. Incluye solo los que fueron inscritos como primer nombre. 
...
El dataframe `guaguas` contiene 845400 observaciones para cinco variables:
...
El dataframe `guaguas_frecuentes` contiene una muestra de 85463 observaciones, que corresponden a los nombres con al menos 15 ocurrencias por año. 
...
* [`ukbabynames`](https://github.com/mine-cetinkaya-rundel/ukbabynames): nombres registrado en el Reino Unido.
