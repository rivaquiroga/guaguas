...
El dataframe `guaguas` contiene 845358 observaciones para cinco variables:
...
El dataframe `guaguas_frecuentes` contiene una muestra de 85463 observaciones, que corresponde a los nombres con al menos 15 ocurrencias por año. 
